    ...
    <div class="gray100 mt-10 w-72 pb-4 rounded elevation-1 flex flex-col justify-start ">
        <form action="/login" method="POST" >
            <div class="green300 h-14 flex items-center">
                <span class="font-bold text-3xl pl-3 text-bluegray900" >Acceso</span>
            </div>
            <div class="flex flex-grow flex-col p-3">
                
                <input placeholder="Correo Electrónico" autocomplete="off" name="username" class="outline-none appearance-none rounded border-solid border-gray400 border border-solid h-6 pt-1 pb-1 pl-2 pr-2 focus:border focus:border-green600 text-bluegray900" type="text">
                <br>
                <input placeholder="Contraseña" autocomplete="off" name="password" class="outline-none appearance-none rounded border-solid border-gray400 border border-solid h-6 pt-1 pb-1 pl-2 pr-2 focus:border focus:border-green600 text-bluegray900" type="password">
